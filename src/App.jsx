    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6 antialiased lg:flex justify-center items-center">
      <section className="lg:flex max-w-[920px]">
        <div className="bg-orange p-12 max-lg:rounded-t-lg lg:rounded-l-lg">
          ...
          <a className="font-lexend bg-offwhitebg px-10 py-3 block w-fit rounded-3xl text-orange border-2 border-offwhitebg hover:bg-orange hover:text-offwhite" href="https://www.webmotors.com.br/sedans" target="_blank" >Ver mais</a>
        </div>
        ...
        <div className="bg-green p-12">
          ...
          <a className="font-lexend  bg-offwhitebg px-10 py-3 block w-fit rounded-3xl text-green border-2 border-offwhitebg hover:bg-green hover:text-offwhite" href="https://www.webmotors.com.br/suvs"  target="_blank" >Ver mais</a>
        </div>
