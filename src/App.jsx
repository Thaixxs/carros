    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6">
      <section>
        <div className="bg-orange p-12 rounded-t-lg">
          ...
          <h2 className="font-shoulders mb-7 uppercase text-4xl text-offwhitebg font-bold">Sedans</h2>
          ...
          <a href="https://www.webmotors.com.br/sedans" target="_blank" className="font-lexend bg-offwhitebg px-10 py-3 block w-fit rounded-3xl text-orange">Ver mais</a>
        </div>

        <div className="bg-green p-12">
          <img src={iconSuvs} alt="ícone dos carros SUVs" className="mb-7"/>
          <h2 className="font-shoulders mb-7 uppercase text-4xl text-offwhitebg font-bold">SUVs</h2>
          ...
          <a href="https://www.webmotors.com.br/suvs"  target="_blank" className="font-lexend  bg-offwhitebg px-10 py-3 block w-fit rounded-3xl text-green">Ver mais</a>
        </div>

        <div className="bg-dark-green p-12 rounded-b-lg">
          <img src={iconLuxury} alt="ícone dos carros Luxury" className="mb-7"/>
          <h2 className="font-shoulders mb-7 uppercase text-4xl text-offwhitebg font-bold" >Luxury</h2>
          ...
          <a href="https://www.webmotors.com.br/carros-de-luxo"  target="_blank" className="font-lexend  bg-offwhitebg px-10 py-3 block w-fit rounded-3xl text-dark-green">Ver mais</a>
        </div>
      </section>
    </main>
  )
